...
try{
let sql='SELECT fases.fase,fases.historia,fases.url_imagen,discos.nombre_disco,villanos.villano FROM fases JOIN discos ON fases.id_disk = discos.id_disk JOIN villanos ON fases.villano=villanos.id ORDER BY fase'
